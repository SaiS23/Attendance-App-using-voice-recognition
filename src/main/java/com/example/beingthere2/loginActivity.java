...
public class loginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView logo=findViewById(R.id.logologin);
    ...
    public void verify(String dbpassword) {
        try {
            ...
            } else if (item == "Teacher" && pass.equals(this.dbpassword)) {
            ...
            } else if (item == "Admin" && pass.equals(loginActivity.this.dbpassword) ) {
